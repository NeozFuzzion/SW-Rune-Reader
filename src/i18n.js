...
const translations = {
    en: {
        ...
        // Filter page
        navFilter: '🚧 Filter',
        filterPageTitle: 'Rune Filter — Sell Advisor',
        presetNamePlaceholder: 'Preset name...',
        addPreset: 'New Preset',
        exportPreset: 'Export',
        importPreset: 'Import',
        importError: 'Invalid preset file',
        rulesTitle: 'Keep Rules',
        rulesDesc: 'Runes matching at least one rule will be kept. Others will be marked for sale.',
        minLevel: 'Min +',
        maxLevel: 'Max +',
        metricLabel: 'Metric',
        minValueLabel: 'Min value',
        substatRequirements: 'Substat requirements',
        chooseStat: 'Stat...',
        addSubstatReq: 'Add substat',
        addRule: 'Add Rule',
        toSell: 'To Sell',
        toKeep: 'To Keep',
        noPresetMessage: 'Create a preset to start filtering your runes.',
    },
    fr: {
        appTitle: 'JSON Manipulator by NeozFuzzion',
        navRunes: 'Runes',
        ...
        // Filter page
        navFilter: '🚧 Filtre',
        filterPageTitle: 'Filtre de runes — Conseiller de vente',
        presetNamePlaceholder: 'Nom du preset...',
        addPreset: 'Nouveau Preset',
        exportPreset: 'Exporter',
        importPreset: 'Importer',
        importError: 'Fichier preset invalide',
        rulesTitle: 'Règles de conservation',
        rulesDesc: 'Les runes correspondant à au moins une règle seront conservées. Les autres seront marquées à vendre.',
        minLevel: 'Min +',
        maxLevel: 'Max +',
        metricLabel: 'Métrique',
        minValueLabel: 'Valeur min',
        substatRequirements: 'Substats requises',
        chooseStat: 'Stat...',
        addSubstatReq: 'Ajouter substat',
        addRule: 'Ajouter une règle',
        toSell: 'À vendre',
        toKeep: 'À garder',
        noPresetMessage: 'Créez un preset pour commencer à filtrer vos runes.',
    }
};
